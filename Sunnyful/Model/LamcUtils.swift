...
struct LamcUtils {
    static let shared: LamcUtils = {
        let instance = LamcUtils()
    ...
    func convertGRID_GPS(toXY: Bool, lat_x: Double, lot_y: Double) -> LatXLngY {
